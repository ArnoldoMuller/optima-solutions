...
export default async function handler(req, res) {
  ...
  try {
    const body = req.body; // { price, nome, email, crm, especialidade, celular, endereco, cidade, uf, scrub, restricao, restricao_detalhe }
    ...
    const preference = {
      ...
      payment_methods: {
        // no_fees → até 6x, painel MP absorve os juros (Parcelado vendedor até 6x)
        // with_fees → até 10x, comprador paga os juros (Parcelado comprador)
